...
public class StatusBarUtils {
     ...
     */
    private static final int BACKGROUND_COLOR_DEFAULT = R.color.util_statusbar_background;

    private static int sColor = BACKGROUND_COLOR_DEFAULT;
     ...
     * @param resColor
     */
    public static void setBackgroundColorDefault(int resColor) {
        sColor = resColor;
    }
